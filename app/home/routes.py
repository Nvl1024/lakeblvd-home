...
def about():
    ...
    md_html = markdown.markdown(md_content, extensions=["fenced_code", "tables"])
    # clean up the html
    allowed_tags = list(bleach.sanitizer.ALLOWED_TAGS) + ["p", "pre", "code", "h1", "h2", "h3", "table", "thead", "tbody", "tr", "th", "td", "ul", "ol", "li", "blockquote"]
